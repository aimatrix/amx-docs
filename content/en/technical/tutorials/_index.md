...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 30px; margin: 40px 0;">
  ...
  <div class="tutorial-card">
    ...
    <a href="/technical/tutorials/videos/getting-started" style="color: #00ff00;">Watch Video →</a>
  </div>
  ...
  <div class="tutorial-card">
    ...
    <a href="/technical/tutorials/videos/first-agent" style="color: #00ff00;">Watch Video →</a>
  </div>
  ...
  <div class="tutorial-card">
    ...
    <a href="/technical/tutorials/videos/orchestration" style="color: #00ff00;">Watch Video →</a>
  </div>
